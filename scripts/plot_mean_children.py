...
PLOT_ATTRIBUTE_FILE_NAME = "children"
...
sns.lineplot(data=all_data, x="Generation", y="ChildImproved", color="g", label="Improved")
sns.lineplot(data=all_data, x="Generation", y="ChildWorsened", color="r", label="Worsened")
