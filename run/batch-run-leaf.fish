...
set DEFAULT_ARGS --swap-terminal-probability 0.5 --swap-operator-probability 0.5 --crossover-probability 0.9 --mutation-probability 0.3 --tournament-size 2 --elitism-size 1 --max-generations 100 --population-size 100 --max-depth 7 --verbose breast_cancer_coimbra
...
for i in 0.05 0.2 0.3 0.4 0.5
    for j in (seq 1 $NUMBER_OF_REPETITIONS)
        ...
        set ARGS $DEFAULT_ARGS --leaf-probability $i --seed $SEED
